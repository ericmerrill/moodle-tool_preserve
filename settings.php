...
if ($hassiteconfig) {
    ...
    $ADMIN->add('root', new admin_externalpage('toolpreserve', get_string('pluginname', 'tool_preserve'), $CFG->wwwroot.'/'.$CFG->admin.'/tool/preserve/index.php', 'moodle/site:config'));
}
